...
Colonies touching each other will strongly affect perimeter and halo measurments. For this reason, the program excludes merging zones from perimeter and halo calculations. It further exports the sum of the estimated arc length for touching colonies (Alpha values). This sume can be greater than colony perimeter if touching colonies have common merging arcs due to their large radius.
